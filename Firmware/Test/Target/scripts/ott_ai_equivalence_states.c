...
const char g_ai_equivalence_digest[] = "41cc70f5ce88b97e";
...
const ai_equivalence_case_t g_ai_equivalence_cases[] = {
    /* --- ordinary play: the normal maze, level 1 ------------------------------------- */
    {
        ...
        .state =
            {
                .pacman = {.column = 15U, .row = 23U, .direction = 3U, .progress = 2U},
                .ghosts =
                    {
                        {.column = 15U, .row = 11U, .direction = 3U, .progress = 227U},
                        {.column = 13U, .row = 13U, .direction = 1U, .progress = 227U},
                ...
                .has_pellet = {0x00U, 0x00U, 0x00U, 0xE0U, 0xFFU, 0xF9U, 0x7FU, 0x42U, 0x90U, 0x20U, 0x24U,
                               ...
                               0x42U, 0x90U, 0x20U, 0xE4U, 0xFCU, 0xF1U, 0x73U, 0x48U, 0x02U, 0x24U, 0x81U,
    ...
    /* --- frightened mode: the normal maze, level 1 ------------------------------------- */
    {
        ...
        .state =
            {
                .pacman = {.column = 26U, .row = 23U, .direction = 3U, .progress = 6U},
                .ghosts =
                    {
                        {.column = 21U, .row = 5U, .direction = 4U, .progress = 90U},
                        {.column = 6U, .row = 4U, .direction = 1U, .progress = 90U},
                        {.column = 14U, .row = 11U, .direction = 3U, .progress = 90U},
                        {.column = 15U, .row = 14U, .direction = 0U, .progress = 255U},
                    },
                .has_pellet = {0x00U, 0x00U, 0x00U, 0xE0U, 0xFFU, 0xF9U, 0x7FU, 0x42U, 0x90U, 0x20U, 0x24U,
                               0x04U, 0x09U, 0x42U, 0x42U, 0x90U, 0x20U, 0xE4U, 0xFFU, 0xFFU, 0x7FU, 0x42U,
                               0x02U, 0x24U, 0x24U, 0x24U, 0x40U, 0x42U, 0x7EU, 0x9EU, 0xE7U, 0x07U, 0x04U,
                               0x00U, 0x02U, 0x40U, 0x00U, 0x20U, 0x00U, 0x04U, 0x00U, 0x02U, 0x40U, 0x00U,
                               0x20U, 0x00U, 0x04U, 0x00U, 0x02U, 0x40U, 0x00U, 0x00U, 0x00U, 0x04U, 0x00U,
                               0x00U, 0x40U, 0x00U, 0x00U, 0x00U, 0x04U, 0x00U, 0x00U, 0x40U, 0x00U, 0x00U,
                               0x00U, 0x04U, 0x00U, 0x00U, 0xFEU, 0x1FU, 0xC0U, 0x27U, 0x04U, 0x01U, 0x40U,
                               0x42U, 0x10U, 0x00U, 0x24U, 0xFCU, 0x01U, 0x00U, 0x40U, 0x02U, 0x20U, 0x00U,
                               0x24U, 0x00U, 0x02U, 0x70U, 0x1EU, 0xE0U, 0x00U, 0x00U, 0x01U, 0x00U, 0x00U,
                ...
                .is_power = {0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x20U, 0x00U, 0x00U,
                             ...
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x20U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U},
                .score = 810UL,
                .lives = 2U,
    ...
    /* --- in a tunnel: generated maze, seed 1, level 1 ------------------------------------- */
    {
        ...
        .state =
            {
                .pacman = {.column = 24U, .row = 17U, .direction = 2U, .progress = 9U},
                .ghosts =
                    {
                        {.column = 21U, .row = 3U, .direction = 1U, .progress = 238U},
                        {.column = 6U, .row = 6U, .direction = 1U, .progress = 238U},
                        {.column = 11U, .row = 14U, .direction = 0U, .progress = 255U},
                        {.column = 15U, .row = 14U, .direction = 0U, .progress = 255U},
                    },
                .has_pellet = {0x00U, 0x00U, 0x00U, 0xE0U, 0xFFU, 0xFFU, 0x7FU, 0x42U, 0x90U, 0x20U, 0x24U,
                               ...
                               0x20U, 0xE4U, 0x07U, 0x00U, 0x60U, 0x40U, 0x00U, 0x00U, 0x00U, 0x04U, 0x00U,
                               0x00U, 0x40U, 0x00U, 0x00U, 0x00U, 0x04U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                               0x00U, 0x00U, 0x00U, 0x00U, 0xC0U, 0x9FU, 0x03U, 0x00U, 0x04U, 0x09U, 0x00U,
                               0x40U, 0x90U, 0x00U, 0x80U, 0x3FU, 0x01U, 0x1CU, 0x48U, 0x12U, 0x20U, 0x81U,
                               0x24U, 0x01U, 0x12U, 0x4EU, 0x1EU, 0x20U, 0x27U, 0x04U, 0x09U, 0x42U, 0x42U,
        ...
        .state =
            {
                ...
                .has_pellet = {0x00U, 0x00U, 0x00U, 0xE0U, 0xFFU, 0xF9U, 0x7FU, 0x42U, 0x90U, 0x20U, 0x24U,
                               ...
                               0x00U, 0x40U, 0x00U, 0x00U, 0x00U, 0x04U, 0x00U, 0x00U, 0x40U, 0x00U, 0x00U,
                               0x00U, 0x04U, 0x00U, 0x00U, 0xFEU, 0x1FU, 0xC0U, 0x27U, 0x04U, 0x01U, 0x40U,
                               0x42U, 0x10U, 0x00U, 0x24U, 0xFCU, 0x31U, 0x70U, 0x40U, 0x02U, 0x20U, 0x01U,
                               0x24U, 0x00U, 0x12U, 0x70U, 0x1EU, 0xE0U, 0x07U, 0x00U, 0x01U, 0x40U, 0x00U,
                               0x10U, 0x00U, 0x04U, 0x00U, 0xF0U, 0x7FU, 0x00U, 0x00U, 0x00U, 0x00U},
                .is_power = {0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x20U, 0x00U, 0x00U,
                             0x40U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
