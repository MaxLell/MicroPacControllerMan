...
const char g_ai_equivalence_digest[] = "ec66ee57464204c2";
...
const ai_equivalence_case_t g_ai_equivalence_cases[] = {
    ...
    /* --- frightened mode: the normal maze, level 1 ------------------------------------- */
    {
        ...
        .state =
            {
                .pacman = {.column = 1U, .row = 23U, .direction = 4U, .progress = 13U},
                .ghosts =
                    {
                        {.column = 23U, .row = 14U, .direction = 3U, .progress = 0U},
                        {.column = 6U, .row = 13U, .direction = 2U, .progress = 149U},
                        {.column = 13U, .row = 13U, .direction = 3U, .progress = 149U},
                        {.column = 15U, .row = 14U, .direction = 0U, .progress = 255U},
                    },
                .has_pellet = {0x00U, 0x00U, 0x00U, 0xE0U, 0xFFU, 0xF9U, 0x7FU, 0x42U, 0x90U, 0x20U, 0x24U,
                               0x04U, 0x09U, 0x42U, 0x42U, 0x90U, 0x20U, 0xE4U, 0xFFU, 0xFFU, 0x7FU, 0x42U,
                               0x02U, 0x24U, 0x24U, 0x24U, 0x40U, 0x42U, 0x7EU, 0x9EU, 0xE7U, 0x07U, 0x04U,
                               0x00U, 0x02U, 0x40U, 0x00U, 0x20U, 0x00U, 0x04U, 0x00U, 0x02U, 0x40U, 0x00U,
                               0x20U, 0x00U, 0x04U, 0x00U, 0x02U, 0x00U, 0x00U, 0x20U, 0x00U, 0x00U, 0x00U,
                               0x02U, 0x00U, 0x00U, 0x20U, 0x00U, 0x00U, 0x00U, 0x02U, 0x00U, 0x00U, 0x20U,
                               0x00U, 0x00U, 0x00U, 0x02U, 0x3EU, 0x80U, 0xFFU, 0x27U, 0x00U, 0x08U, 0x42U,
                               0x02U, 0x80U, 0x20U, 0x04U, 0xF8U, 0xF8U, 0x73U, 0x00U, 0x02U, 0x24U, 0x01U,
                               0x20U, 0x40U, 0x12U, 0x06U, 0x9EU, 0xE7U, 0x27U, 0x00U, 0x09U, 0x40U, 0x02U,
                               0x90U, 0x00U, 0xE4U, 0xFFU, 0xFFU, 0x7FU, 0x00U, 0x00U, 0x00U, 0x00U},
                .is_power = {0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x20U, 0x00U, 0x00U,
                             0x40U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             ...
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x40U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                             0x00U, 0x00U, 0x00U, 0x00U, 0x00U},
                .score = 340UL,
                .lives = 3U,
    ...
    /* --- in a tunnel: generated maze, seed 1, level 1 ------------------------------------- */
    {
        ...
        .state =
            {
                .pacman = {.column = 3U, .row = 20U, .direction = 1U, .progress = 16U},
                .ghosts =
                    {
                        {.column = 23U, .row = 1U, .direction = 3U, .progress = 198U},
                        {.column = 6U, .row = 2U, .direction = 1U, .progress = 198U},
                        {.column = 11U, .row = 14U, .direction = 0U, .progress = 255U},
                        {.column = 15U, .row = 14U, .direction = 0U, .progress = 255U},
                    },
                .has_pellet = {0x00U, 0x00U, 0x00U, 0xE0U, 0xFFU, 0xFFU, 0x7FU, 0x42U, 0x90U, 0x20U, 0x24U,
                               ...
                               0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x80U, 0x3FU, 0x00U, 0x00U, 0x08U, 0x02U,
                               0x00U, 0x80U, 0x20U, 0x00U, 0x38U, 0xC8U, 0x1FU, 0x48U, 0x92U, 0x24U, 0x81U,
        ...
        .state =
            {
                ...
                .has_pellet = {0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                               ...
                               0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x04U,
                               0x00U, 0x00U, 0x40U, 0x00U, 0x00U, 0x00U, 0x04U, 0x00U, 0x00U, 0x40U, 0x00U,
                               0x00U, 0x00U, 0x04U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                               0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
                               0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x80U, 0x1FU, 0x00U, 0x00U, 0x08U, 0x02U,
                               0x00U, 0x80U, 0x20U, 0x00U, 0xF8U, 0xF8U, 0x03U, 0x00U, 0x02U, 0x24U, 0x00U,
                               0x20U, 0x40U, 0x02U, 0x00U, 0x9EU, 0xE7U, 0x00U, 0x00U, 0x09U, 0x00U, 0x00U,
                               0x90U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U},
