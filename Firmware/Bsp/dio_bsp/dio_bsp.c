...
static const dio_bsp_pin_map_t g_pin_map[DIO_BSP_PIN_LAST] = {
    ...
    [DIO_BSP_PIN_DISPLAY_DCX] = {DISPLAY_DCX_GPIO_Port, DISPLAY_DCX_Pin},
    [DIO_BSP_PIN_DISPLAY_RESET] = {DISPLAY_RESET_GPIO_Port, DISPLAY_RESET_Pin},
    [DIO_BSP_PIN_DISPLAY_TE] = {DISPLAY_TE_GPIO_Port, DISPLAY_TE_Pin},
    [DIO_BSP_PIN_JOYSTICK_NORTH] = {JOYSTICK_NORTH_GPIO_Port, JOYSTICK_NORTH_Pin},
    [DIO_BSP_PIN_JOYSTICK_SOUTH] = {JOYSTICK_SOUTH_GPIO_Port, JOYSTICK_SOUTH_Pin},
    [DIO_BSP_PIN_JOYSTICK_EAST] = {JOYSTICK_EAST_GPIO_Port, JOYSTICK_EAST_Pin},
    [DIO_BSP_PIN_JOYSTICK_WEST] = {JOYSTICK_WEST_GPIO_Port, JOYSTICK_WEST_Pin},
    [DIO_BSP_PIN_JOYSTICK_CENTER] = {JOYSTICK_CENTER_GPIO_Port, JOYSTICK_CENTER_Pin},
};
