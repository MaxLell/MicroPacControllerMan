...
| FR-037 | AI Play Strength | Over 20 full runs on the generated mazes of seeds 1000 to 1019, the AI shall reach a mean final score of at least 4,600 points, with every rule of the game in force. *(ten times the measured mean of a uniform-random policy — 464.3 points over 329 episodes; clearing level 1 alone is worth about 2,600. Both figures tunable; the seed set and why it is a range rather than a list are in [M6 Pacman AI §13](../Design/M6-Pacman-AI.md))* |
