...
| FR-037 | AI Play Strength | Over a fixed set of seeded runs on generated mazes (FR-029), the AI shall reach a mean score of at least 4,600 points. *(ten times the measured mean of a uniform-random policy — 464.3 points over 329 episodes; clearing level 1 alone is worth about 2,600. Tunable, and the seed set is still to be fixed — see [M6 Pacman AI §12](../Design/M6-Pacman-AI.md))* |
